"""Sequential substation heuristic baseline from the Section IV-A case study.

The method optimizes candidate substation configurations one at a time while
carrying the accepted topology decisions into subsequent solves.
"""
...
def Create_v67_AC_MIP(data,cont_list=None,
                                        Max_Sw_bus=0,
...
# %%
def Solve_MIP_v67(data,TopologyFix,model0,cont_list,substation,print_result=False):
...
def BCC_v67_AC_subi_heuristic(data,cont_list=None,
                                        Max_Sw_bus=0,
                                    Up_redispatch=0,Dn_redispatch=1.0,
                                           Zfixdict=None,#fixed topology
                                    Zinitial=None,
...
#     Max_timelimit=data['Max_timelimit']=600 #900
    ...
    model0 = Create_v67_AC_MIP(data=data,cont_list=cont_list,
                                        Max_Sw_bus=Max_Sw_bus,
    ...
    for sub in tqdm(Bus):
        ...
        res = Solve_MIP_v67(data=data,substation=sub,TopologyFix=TopologyFix_updated,model0=model0,cont_list=cont_list,print_result=print_result)
